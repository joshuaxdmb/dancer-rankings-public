  ...
  return (
    <Dialog.Root open={isOpen} defaultOpen={isOpen} onOpenChange={onChange}>
      <Dialog.Portal>
        ...
        <Dialog.Content
          className={`z-40 fixed drop-shadow-md border border-neutral-700 top-[50%] left-[50%] max-h-full h-auto md:max-h-[85vh] w-[90%] md:w-[90vh] md:max-w-[450px] translate-x-[-50%] translate-y-[-50%]
